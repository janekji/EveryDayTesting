    ...
    describe 'PATCH #update' do
      ...
      context "with valid attributes" do
        ...
        it "changes @contact's attributes" do
          contact_attributes = attributes_for(:contact, firstname: "Larry", lastname: "Smith")
          patch :update, id: @contact, contact: contact_attributes
          @contact.reload
      ...
      context "with invalid attributes" do
        it "does not update the contact" do
          contact_attributes = attributes_for(:contact, firstname: "Larry", lastname: nil)
          patch :update, id: @contact, contact: contact_attributes
          @contact.reload
