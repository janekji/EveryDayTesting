...
RSpec.describe NewsReleasesController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      NewsRelease.create! valid_attributes
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested news_release" do
        news_release = NewsRelease.create! valid_attributes
        put :update, {:id => news_release.to_param, :news_release => new_attributes}, valid_session
        news_release.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        news_release = NewsRelease.create! valid_attributes
        put :update, {:id => news_release.to_param, :news_release => invalid_attributes}, valid_session
        expect(response).to be_successful
      end
    end
  end
